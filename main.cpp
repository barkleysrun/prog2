...
template<int SIZE>
std::shared_ptr<swc::Set<int>> getRandomSet() {
    std::shared_ptr<swc::Set<int>> toRet(new swc::BinarySearchTree<int, void *>());
...
bool testIsEmpty_afterConstruct_isEmpty() {
    ...
    swc::BinarySearchTree<char, void *> uut;
...
bool testSize_afterInsertingRandomOrder_correctAlongTheWay() {
    ...
    std::shared_ptr<swc::Set<int>> uut(new swc::BinarySearchTree<int,int>);
...
bool testSize_afterRemovingAllSIZEItems_correctAlongTheWay() {
    ...
    std::unique_ptr<swc::Set<int>> uut(new swc::BinarySearchTree<int, void *>());
...
bool testInsert_SIZEIdenticalItems_sizeEqualsOne() {
    std::shared_ptr<swc::Set<char>> uut(new swc::BinarySearchTree<char, bool>());
...
bool testClear_insertSIZERandomitems_isEmpty() {
    ...
    std::shared_ptr<swc::Set<int>> uut = getRandomSet<TEST_SIZE>();
...
bool testRemove_itemMissing_returnsFalse() {
    std::shared_ptr<swc::Set<char>> uut(new swc::BinarySearchTree<char,char>());
    uut->insert('.');
...
bool testRemove_sameProbeValuesSIZETimesWhileBuilding_presentNotPresent() {
    ...
    std::shared_ptr<swc::Set<int>> uut(new swc::BinarySearchTree<int, void *>());
...
bool testRemove_withChildren_presentNotPresent() {
    // BUILD
    swc::BinarySearchTree<int, void *> uut;
    int sequence[SIZE - 1];
...
bool testGet_changedValue_valueUpdatedInMap() {
    std::shared_ptr<swc::Map<int, int>> uut(new swc::BinarySearchTree<int, int>);
...
bool testInsertKeyValue_uniqueKeysValues_allPresent(){
    ...
    std::shared_ptr<swc::BinarySearchTree<int,int>> uut(new swc::BinarySearchTree<int,int>());
    for(int i = 0; i<SIZE-1; i++)
        uut->insert(seq[i], i);
